...
class PluginControllerApi(object):
    ...
    def get_plugins_using_get_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/api/plugins', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[PluginMetaData]',
                                        auth_settings=auth_settings,
                                        asynch=params.get('async'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_system_plugins_using_get(self, limit, **kwargs):
        """
        getSystemPlugins
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_system_plugins_using_get(limit, async=True)
        >>> result = thread.get()
        ...
        :return: TextPageDataPluginMetaData
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_system_plugins_using_get_with_http_info(limit, **kwargs)
        else:
            (data) = self.get_system_plugins_using_get_with_http_info(limit, **kwargs)
            return data

    def get_system_plugins_using_get_with_http_info(self, limit, **kwargs):
        """
        getSystemPlugins
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_system_plugins_using_get_with_http_info(limit, async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_system_plugins_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'limit' is set
        if ('limit' not in params) or (params['limit'] is None):
            raise ValueError("Missing the required parameter `limit` when calling `get_system_plugins_using_get`")
        ...
        return self.api_client.call_api('/api/plugin/system', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='TextPageDataPluginMetaData',
                                        auth_settings=auth_settings,
                                        asynch=params.get('async'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_tenant_plugins_using_get(self, tenant_id, limit, **kwargs):
        """
        getTenantPlugins
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_tenant_plugins_using_get(tenant_id, limit, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_tenant_plugins_using_get_with_http_info(tenant_id, limit, **kwargs)
        else:
            (data) = self.get_tenant_plugins_using_get_with_http_info(tenant_id, limit, **kwargs)
            return data

    def get_tenant_plugins_using_get_with_http_info(self, tenant_id, limit, **kwargs):
        """
        getTenantPlugins
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_tenant_plugins_using_get_with_http_info(tenant_id, limit, async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tenant_plugins_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'tenant_id' is set
        if ('tenant_id' not in params) or (params['tenant_id'] is None):
            raise ValueError("Missing the required parameter `tenant_id` when calling `get_tenant_plugins_using_get`")
        # verify the required parameter 'limit' is set
        if ('limit' not in params) or (params['limit'] is None):
            raise ValueError("Missing the required parameter `limit` when calling `get_tenant_plugins_using_get`")
        ...
        return self.api_client.call_api('/api/plugin/tenant/{tenantId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_tenant_plugins_using_get1(self, limit, **kwargs):
        """
        getTenantPlugins
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_tenant_plugins_using_get1(limit, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_tenant_plugins_using_get1_with_http_info(limit, **kwargs)
        else:
            (data) = self.get_tenant_plugins_using_get1_with_http_info(limit, **kwargs)
            return data

    def get_tenant_plugins_using_get1_with_http_info(self, limit, **kwargs):
        """
        getTenantPlugins
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_tenant_plugins_using_get1_with_http_info(limit, async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tenant_plugins_using_get1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'limit' is set
        if ('limit' not in params) or (params['limit'] is None):
            raise ValueError("Missing the required parameter `limit` when calling `get_tenant_plugins_using_get1`")
        ...
        return self.api_client.call_api('/api/plugin', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def save_plugin_using_post(self, source, **kwargs):
        """
        savePlugin
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.save_plugin_using_post(source, async=True)
        >>> result = thread.get()

        :param async bool
        :param PluginMetaData source: source (required)
        :return: PluginMetaData
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.save_plugin_using_post_with_http_info(source, **kwargs)
        else:
            (data) = self.save_plugin_using_post_with_http_info(source, **kwargs)
            return data

    def save_plugin_using_post_with_http_info(self, source, **kwargs):
        """
        savePlugin
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.save_plugin_using_post_with_http_info(source, async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method save_plugin_using_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'source' is set
        if ('source' not in params) or (params['source'] is None):
            raise ValueError("Missing the required parameter `source` when calling `save_plugin_using_post`")
        ...
        return self.api_client.call_api('/api/plugin', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def suspend_plugin_by_id_using_post(self, plugin_id, **kwargs):
        """
        suspendPluginById
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.suspend_plugin_by_id_using_post(plugin_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.suspend_plugin_by_id_using_post_with_http_info(plugin_id, **kwargs)
        else:
            (data) = self.suspend_plugin_by_id_using_post_with_http_info(plugin_id, **kwargs)
            return data

    def suspend_plugin_by_id_using_post_with_http_info(self, plugin_id, **kwargs):
        """
        suspendPluginById
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.suspend_plugin_by_id_using_post_with_http_info(plugin_id, async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method suspend_plugin_by_id_using_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'plugin_id' is set
        if ('plugin_id' not in params) or (params['plugin_id'] is None):
            raise ValueError("Missing the required parameter `plugin_id` when calling `suspend_plugin_by_id_using_post`")
        ...
        return self.api_client.call_api('/api/plugin/{pluginId}/suspend', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
